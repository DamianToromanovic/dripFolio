...
export default function About() {
  return (
    <section className=" py-6 px-6 text-xl">
      ...
      <p className="mb-12 text-base sm:text-xl">
      ...
      <h2 className=" sm:text-3xl font-bold mb-8 ">What i offer</h2>

      <Services />
      <h2 className="sm:text-3xl font-bold mb-8 mt-12">My Tech Stack</h2>
      <Techstack />
    </section>
  );
}
